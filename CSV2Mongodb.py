...
# 2:连接本地数据库(guazidata)。没有时会自动创建,可更改数据库名称
db=conn.GPSData
# 3:创建集合
#myset=db.totaldata
...
"""
#运行示例
Insert("H:\GPS_Data\\20170901\\20170901.csv","gpstotaldata")
lis =SortTrunk.Get_top_trunk_list("H:\GPS_Data\\20170901\\Top20Sort_part1.json")
print("此部分共计{}辆车".format(len(lis)))
start = time.time()
Inquire(lis,"H:\GPS_Data\\20170901\Top20\\Top20Trunk","gpstotaldata")
